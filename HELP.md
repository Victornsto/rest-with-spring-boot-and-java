...
* The original package name 'com.victornsto.rest-with-spring-boot-and-java' is invalid and this project uses 'com.victornsto.restwithspringbootandjava' instead.
